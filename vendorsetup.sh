...
git clone https://github.com/ArrowOS/android_vendor_nxp_opensource_packages_apps_Nfc.git -b arrow-12.1 vendor/nxp/opensource/commonsys/packages/apps/Nfc
git clone https://github.com/ArrowOS/android_vendor_nxp_opensource_halimpl.git -b arrow-12.1-sn100x vendor/nxp/opensource/sn100x/halimpl
git clone https://github.com/ArrowOS/android_vendor_nxp_opensource_hidlimpl.git -b arrow-12.1-sn100x vendor/nxp/opensource/sn100x/hidlimpl
git clone https://github.com/ArrowOS/android_vendor_qcom_opensource_interfaces.git -b arrow-12.1 vendor/qcom/opensource/interfaces
